...
; The file to write
OutFile "Plugin_OSC_${VERSION}.exe"
...
; Sections
Section "OSC" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\OSC"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\OSC\Plugin_OSC.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\OSC\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\OSC"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\OSC\Plugin_OSC.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\OSC\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_OSC"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_OSC\inc"
...
; Set Fileinfos
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "OSC Plugin"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2012, The authors of the OSC Plugin project"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "OSC Plugin for CryEngine"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_OSC\changelog.md"'
FunctionEnd
